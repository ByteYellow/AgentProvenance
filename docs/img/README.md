...
Reserved spots for screenshots referenced from the top-level `README.md`. Drop the
PNGs here with these exact names:
...
To produce them: replay the captured run and open the dashboard —
